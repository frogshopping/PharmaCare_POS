...
import { Package, getPackages } from '@/services/api';
        ...
        <DashboardLayout>
            <div className="min-h-screen">
                <div className="flex justify-between items-center p-6 pb-4">
                    <h1 className="text-2xl font-light text-slate-700">Package Items</h1>
                            ...
                            <table className="w-full text-sm text-left">
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 border-b">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 font-medium">Package Title</th>
                                ...
                                <tbody>
                                    {packages.map((item) => (
                                        <tr key={item.id} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4">{item.packageTitle}</td>
                                            <td className="px-6 py-4">{item.price.toFixed(1)}</td>
